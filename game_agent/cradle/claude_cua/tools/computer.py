...
class PyAutoGUIComputerTool:
    ...
    # Define which actions should be counted toward the limit
    _countable_actions = [
        # Mouse actions that count as intended interactions
        "left_click", "right_click", "middle_click", "double_click", "triple_click",
        # Keyboard actions that count as intended interactions
        "key", "type", "hold_key",
        # Drag actions
        "left_click_drag",
        # Scroll actions
    ...
    # Actions that don't count toward the limit
    _uncountable_actions = [
        "mouse_move", "screenshot", "cursor_position", "wait",
        "left_mouse_down", "left_mouse_up"  # These are part of compound actions
    ]
    ...
    def should_count_action(self, action: str) -> bool:
        """Check if the action should be counted toward the action limit."""
        return action in self._countable_actions
